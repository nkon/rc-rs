...
pub fn run_test() {
    ...
    println!("0b11 -> {:?}", lexer("0b11".to_string()).unwrap());
    println!("1.1 -> {:?}", lexer("1.1".to_string()).unwrap());
    println!("0.1 -> {:?}", lexer("0.1".to_string()).unwrap());
    println!("1 -> {:?}", lexer("1".to_string()).unwrap());
    println!("0 -> {:?}", lexer("0".to_string()).unwrap());
    println!("10 1 -> {:?}", lexer("10 1".to_string()).unwrap());
    println!("1+1 -> {:?}", lexer("1+1".to_string()).unwrap());
    println!("1-1 -> {:?}", lexer("1-1".to_string()).unwrap());
    println!("-1 -> {:?}", lexer("-1".to_string()).unwrap());
    println!("+-*/%()^100 -> {:?}", lexer("+-*/%()^-100".to_string()).unwrap());
    println!("1.234 -> {:?}", lexer("1.234".to_string()).unwrap());
    println!("1.234e-56 -> {:?}", lexer("1.234e-56".to_string()).unwrap());
    println!("-1.234e-56-78 -> {:?}", lexer("-1.234e-56-78".to_string()).unwrap());
    println!(
        "1/(2*3.14*270e-12*31.4e3) -> {:?}",
        lexer("1/(2*3.14*270e-12*31.4e3)".to_string()).unwrap());
    match lexer("0b12".to_string()) {
        Ok(_) => {}
        Err(e) => {println!("{}", e);}
    }
    match lexer("018".to_string()) {
        Ok(_) => {}
        Err(e) => {println!("{}",e);}
    }
    ...
    println!("1+-2 -> {:?}", parse(&(lexer("1+-2".to_string())).unwrap()));
    println!("1*2 -> {:?}", parse(&(lexer("1*2".to_string())).unwrap()));
    println!("1*2+3 -> {:?}", parse(&(lexer("1*2+3".to_string())).unwrap()));
    println!("1+2*3 -> {:?}", parse(&(lexer("1+2*3".to_string())).unwrap()));
    println!("1*(2+3) -> {:?}", parse(&(lexer("1*(2+3)".to_string())).unwrap()));
    println!("(1+2)*3 -> {:?}", parse(&(lexer("(1+2)*3".to_string())).unwrap()));
    println!("1+2+3 -> {:?}", parse(&(lexer("1+2+3".to_string())).unwrap()));
    ...
    println!("1+2 -> {:?}", eval(&parse(&(lexer("1+2".to_string())).unwrap())));
    println!("1-2 -> {:?}", eval(&parse(&(lexer("1-2".to_string())).unwrap())));
    println!("1+-2 -> {:?}", eval(&parse(&(lexer("1+-2".to_string())).unwrap())));
    println!("1*2 -> {:?}", eval(&parse(&(lexer("1*2".to_string())).unwrap())));
    println!("1*2+3 -> {:?}", eval(&parse(&(lexer("1*2+3".to_string()).unwrap()))));
    println!("1+2*3 -> {:?}", eval(&parse(&(lexer("1+2*3".to_string())).unwrap())));
    println!(
        "1*(2+3) -> {:?}",
    ...
    println!(
        "1/(2*3.14*270e-12*31.4e3) -> {:?}",
        eval(&parse(&(lexer("1/(2*3.14*270e-12*31.4e3)".to_string())).unwrap()))
    );
    println!("-(1+2) -> {:?}", eval(&parse(&(lexer("-(1+2)".to_string())).unwrap())));
}
